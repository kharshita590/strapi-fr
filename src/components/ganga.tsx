...
const Ganga = () => {
    const data = [
        {"img":"/images/jal-ganga/g4.jpeg"},
        {"img":"/images/jal-ganga/g1.jpeg"},
        {"img":"/images/jal-ganga/g2.jpeg"},
        {"img":"/images/jal-ganga/g3.jpeg"},
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-md lg:p-16 p-2" >
      ...
      <div className="bg-[#00008B] text-white px-4 py-2 rounded-t-lg flex items-center">
        <span className="text-xl font-bold">जल गंगा सम्वर्धन अभियान</span>
      </div>
